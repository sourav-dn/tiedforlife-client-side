            ...
            <div className="flex flex-col lg:flex-row-reverse items-center gap-10">
                ...
                <Card className="w-full max-w-md shadow-2xl">
                    ...
                    <div className="my-2 mx-6 flex justify-between space-y-2">
                        ...
                        <button onClick={handleGoogleSignIn} type="button" class="text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 me-2 mb-2">
